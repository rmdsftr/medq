  ...
  return (
    ...
    <div className="mx-auto max-w-[100rem] ">\
      ...
      <section className="justify-center text-center bg-blue-200/20">
        <h1 className="font-bold pt-5">Fitur Unggulan</h1>
        <h2 className="text-lg mt-3 ">Solusi lengkap untuk pengalaman rumah sakit yang lebih nyaman</h2>
      ...
      <section className="mx-auto max-w-[100rem] py-12 bg-blue-200/20 ">
        <div className="flex flex-row items-center justify-between gap-10">
            ...
            <p className="text-6xl font-bold text-blueMed mt-4">
                Coba <span className="bg-blue-500 text-white pl-1 pr-1">MedQ</span> Sekarang!
            </p>
            <div className="mt-5">
            <Button label={"Daftar Sekarang"} variant="oren"/>
